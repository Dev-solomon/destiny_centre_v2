...
function updateDeviceInfo() {
  ...
  if (width <= 575) {
    deviceInfo.textContent = `Mobile: ${width}px (Horizontal Scroll)`;
  } else if (width <= 991) {
    deviceInfo.textContent = `Tablet: ${width}px (Grid Layout)`;
  } else {
    deviceInfo.textContent = `Desktop: ${width}px (Horizontal Scroll)`;
  }
}
