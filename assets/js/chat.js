// Sample data
const users = [
  { name: "Martin", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Sandra", status: "online", avatar: "/images/sharon-chat-image.png" },
  { name: "David", status: "online", avatar: "/images/daniel-chat-image.png" },
  {
    name: "Kimberly",
    status: "online",
    avatar: "/images/david-chat-image.png",
  },
  { name: "Mary", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Daniel", status: "online", avatar: "/images/daniel-chat-image.png" },
  {
    name: "Patricia",
    status: "online",
    avatar: "/images/daniel-chat-image.png",
  },
  { name: "Thomas", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Linda", status: "online", avatar: "/images/daniel-chat-image.png" },
  {
    name: "Christopher",
    status: "online",
    avatar: "/images/daniel-chat-image.png",
  ...
  { name: "Joshua", status: "online", avatar: "/images/daniel-chat-image.png" },
  {
    name: "Jessica",
    status: "online",
    avatar: "/images/daniel-chat-image.png",
  },
  { name: "Andrew", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Sarah", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Ryan", status: "online", avatar: "/images/daniel-chat-image.png" },
  {
    name: "Michelle",
    status: "online",
    avatar: "/images/daniel-chat-image.png",
  },
  { name: "Kevin", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Amanda", status: "online", avatar: "/images/daniel-chat-image.png" },
  { name: "Steven", status: "online", avatar: "/images/daniel-chat-image.png" },
];
...
const sampleMessages = [
  ...
  },
  {
    ...
    own: false,
    date: "today",
    image: "/images/chat-image2.png",
  },
  {
    avatar: `/images/chat-image3.png`,
    sender: "Me",
    time: "11:24 am",
    text: "Don't forget to pray for those who voted!",
    own: true,
    date: "today",
    image: "/images/chat-image1.png",
  },
  {
    avatar: `/images/chat-image1.png`,
    sender: "Lella",
